...
def order_option_credit_spread(price, symbol, quantity, spread, timeInForce='gtc', account_number=None, jsonify=True):
    ...
    the price, and the quantity.
    """
    return(order_option_spread("credit", price, symbol, quantity, spread, account_number=account_number, timeInForce=timeInForce, jsonify=jsonify))
...
def order_option_debit_spread(price, symbol, quantity, spread, timeInForce='gtc', account_number=None, jsonify=True):
    ...
    the price, and the quantity.
    """
    return(order_option_spread("debit", price, symbol, quantity, spread, account_number=account_number, timeInForce=timeInForce, jsonify=jsonify))
